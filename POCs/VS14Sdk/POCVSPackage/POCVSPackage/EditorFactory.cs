...
namespace Company.POCVSPackage
{
    ...
    /// </summary>
    [Guid(GuidList.guidPOCVSPackageEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private POCVSPackagePackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(POCVSPackagePackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidPOCVSPackageEditorFactory;
            pgrfCDW = 0;
