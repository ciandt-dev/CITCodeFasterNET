...
namespace Company.POCVSPackage
{
    ...
    //     - An empty pocvspackage file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.pocvspackage. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.pocvspackage, MyExtFile2.pocvspackage... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.pocvspackage|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.pocvspackage - our empty pocvspackage file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".pocvspackage";
        ...
        #region Fields
        private POCVSPackagePackage myPackage;
        ...
        public EditorPane(POCVSPackagePackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the pocvspackage document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(POCVSPackagePackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidPOCVSPackageCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidPOCVSPackageCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidPOCVSPackageEditorFactory;
            return VSConstants.S_OK;
        }
